...
HELP_ITEMS = [
    ...
    ("Num7 / U",       "FL Bigger / Smaller"),
    ("Num8 / I",       "FR Bigger / Smaller"),
    ("Num4 / J",       "ML Bigger / Smaller"),
    ("Num5 / K",       "MR Bigger / Smaller"),
    ("Num1 / N",       "RL Bigger / Smaller"),
    ("Num2 / ,",       "RR Bigger / Smaller"),
    ("Num0 / .",       "ALL Bigger / Smaller"),
